      ...
      >
        ...
        <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
          <a href="#">
            ...
            <h1>Project Management System Gharda</h1>
          </a>
            ...
            <div>
              ...
              <ul class="mb-6 flex flex-col gap-1.5">
                ...
                <li>
                  <a
                    class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                    href="{{ route('instructor.participants') }}"
                    @click="selected = (selected === 'Participants' ? '' :'Participants')"
                    :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Participants') && (page === 'calendar') }"
                  >
                    <svg
                      class="fill-current"
                      width="18"
    ...
    .225-.012.447-.037.666A11.944 11.944 0 0112 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 016 18.719m12 0a5.971 5.971 0 00-.941-3.197m0 0A5.995 5.995 0 0012 12.75a5.995 5.995 0 00-5.058 2.772m0 0a3 3 0 00-4.681
     2.72 8.986 8.986 0 003.74.477m.94-3.197a5.971 5.971 0 00-.94 3.197M15 6.75a3 3 0 11-6 0 3 3 0 016 0zm6 3a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0zm-13.5 0a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z" />
                ...
                <li>
                  <a
                    class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                    href="{{ route('instructor.tasks') }}"
                    @click="selected = (selected === 'tasks' ? '' :'tasks')"
                    :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'tasks') && (page === 'tasks') }"
                  >
                    <svg
                      class="fill-current"
                      width="18"
    ...
    .225-.012.447-.037.666A11.944 11.944 0 0112 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 016 18.719m12 0a5.971 5.971 0 00-.941-3.197m0 0A5.995 5.995 0 0012 12.75a5.995 5.995 0 00-5.058 2.772m0 0a3 3 0 00-4.681
     2.72 8.986 8.986 0 003.74.477m.94-3.197a5.971 5.971 0 00-.94 3.197M15 6.75a3 3 0 11-6 0 3 3 0 016 0zm6 3a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0zm-13.5 0a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z" />
                ...
                <li>
                  <a
                    class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                    href="{{ route('instructor.proposals') }}"
                ...
                <li>
                  <a
                    class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                    href="{{ route('instructor.notifications') }}"
                    @click="selected = (selected === 'Calendar' ? '':'Calendar')"
                    :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Calendar') && (page === 'calendar') }"
                  >
                    <svg
                ...
                <li>
                  <a
                    class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                    href="{{ route('instructor.repositories') }}"
                    @click="selected = (selected === 'Calendar' ? '':'Calendar')"
                    :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Calendar') && (page === 'calendar') }"
                  >
                    <svg
        ...
        {{-- <include src="{{ asset('/partials/sidebar.html') }}"></include> --}}
        <!-- ===== Sidebar End ===== -->
          ...
          >
            <span class="hidden text-right lg:block">
              <span class="block text-sm font-medium text-black dark:text-white"
                >{{ Auth::user()->name }}</span
              >
              <span class="block text-xs font-medium first-letter:capitalize">{{ Auth::user()->user_type }}</span>
            </span>
