    ...
    <body>
        <div class="header-box">
            ...
            <div class="dashboardPannel">
                <a class='btns parti' href="{{ route('superadmin.participants') }}" wire:navigate>
                ...
                <a class='btns noti' href="{{ route('superadmin.notifications') }}" wire:navigate>
                ...
                {{-- <a class='btns repo' href="{{ route('superadmin.repositories') }}" wire:navigate>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                ...
                <a class='btns task' href="{{ route('superadmin.tasks') }}" wire:navigate>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
